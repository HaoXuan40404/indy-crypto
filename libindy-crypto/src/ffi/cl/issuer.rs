...
/// calling cl_revocation_key_public_free and
/// cl_revocation_key_private_free.
///
/// Note that accumulator deallocation must be performed by
/// calling cl_revocation_registry_free.
///
/// Note that tails generator deallocation must be performed by
/// calling cl_revocation_tails_generator_free.
///
/// # Arguments
...
#[no_mangle]
pub extern fn cl_issuer_new_revocation_registry_def(credential_pub_key: *const c_void,
                                                                max_cred_num: u32,
    ...
    trace!("cl_issuer_new_revocation_registry_def: >>> credential_pub_key: {:?}, max_cred_num: {:?}, rev_key_pub_p: {:?}, rev_key_priv_p: {:?}, \
    ...
    trace!("cl_issuer_new_revocation_registry_def: entities: credential_pub_key: {:?}, max_cred_num: {:?}", credential_pub_key, max_cred_num);
    ...
    let res = match Issuer::new_revocation_registry_def(credential_pub_key, max_cred_num, issuance_by_default) {
        Ok((rev_key_pub, rev_key_priv, rev_reg, rev_tails_generator)) => {
            trace!("cl_issuer_new_revocation_registry_def: rev_key_pub_p: {:?}, rev_key_priv: {:?}, rev_reg: {:?}, rev_tails_generator: {:?}",
            ...
            unsafe {
                ...
                *rev_tails_generator_p = Box::into_raw(Box::new(rev_tails_generator)) as *const c_void;
                trace!("cl_issuer_new_revocation_registry_def: *rev_key_pub_p: {:?}, *rev_key_priv_p: {:?}, *rev_reg_p: {:?}, *rev_tails_generator_p: {:?}",
    ...
    trace!("cl_issuer_new_revocation_registry_def: <<< res: {:?}", res);
    res
}
...
#[no_mangle]
pub extern fn cl_revocation_key_public_to_json(rev_key_pub: *const c_void,
                                                           rev_key_pub_json_p: *mut *const c_char) -> ErrorCode {
    trace!("cl_revocation_key_public_to_json: >>> rev_key_pub: {:?}, rev_key_pub_json_p: {:?}",
    ...
    trace!("cl_revocation_key_public_to_json: entity >>> rev_key_pub: {:?}", rev_key_pub);

    let res = match serde_json::to_string(rev_key_pub) {
        Ok(rev_key_pub_json) => {
            trace!("cl_revocation_key_public_to_json: rev_key_pub_json: {:?}", rev_key_pub_json);
            unsafe {
                let rev_reg_def_pub_json = CTypesUtils::string_to_cstring(rev_key_pub_json);
                *rev_key_pub_json_p = rev_reg_def_pub_json.into_raw();
                trace!("cl_revocation_key_public_to_json: rev_key_pub_json_p: {:?}", *rev_key_pub_json_p);
            }
            ErrorCode::Success
        }
        Err(_) => ErrorCode::CommonInvalidState
    ...
    trace!("cl_revocation_key_public_to_json: <<< res: {:?}", res);
    res
}
...
/// by calling cl_revocation_key_public_free
///
/// # Arguments
/// * `rev_key_pub_json` - Reference that contains revocation key public json.
/// * `rev_key_pub_p` - Reference that will contain revocation key public instance pointer.
#[no_mangle]
pub extern fn cl_revocation_key_public_from_json(rev_key_pub_json: *const c_char,
                                                             rev_key_pub_p: *mut *const c_void) -> ErrorCode {
    trace!("cl_revocation_key_public_from_json: >>> rev_key_pub_json: {:?}, rev_key_pub_p: {:?}", rev_key_pub_json, rev_key_pub_p);
    ...
    trace!("cl_revocation_key_public_from_json: entity: rev_key_pub_json: {:?}", rev_key_pub_json);

    let res = match serde_json::from_str::<RevocationKeyPublic>(&rev_key_pub_json) {
        Ok(rev_key_pub) => {
            trace!("cl_revocation_key_public_from_json: rev_key_pub: {:?}", rev_key_pub);
            unsafe {
                *rev_key_pub_p = Box::into_raw(Box::new(rev_key_pub)) as *const c_void;
                trace!("cl_revocation_key_public_from_json: *rev_key_pub_p: {:?}", *rev_key_pub_p);
            }
            ErrorCode::Success
        }
        Err(_) => ErrorCode::CommonInvalidStructure
    ...
    trace!("cl_revocation_key_public_from_json: <<< res: {:?}", res);
    res
}
...
#[no_mangle]
pub extern fn cl_revocation_key_public_free(rev_key_pub: *const c_void) -> ErrorCode {
    trace!("cl_revocation_key_public_free: >>> rev_key_pub: {:?}", rev_key_pub);
    ...
    trace!("cl_revocation_key_public_free: entity: rev_key_pub: {:?}", rev_key_pub);

    let res = ErrorCode::Success;

    trace!("cl_revocation_key_public_free: <<< res: {:?}", res);
    res
}
...
#[no_mangle]
pub extern fn cl_revocation_key_private_to_json(rev_key_priv: *const c_void,
                                                            rev_key_priv_json_p: *mut *const c_char) -> ErrorCode {
    trace!("cl_revocation_key_private_to_json: >>> rev_key_priv: {:?}, rev_key_priv_json_p: {:?}",
    ...
    trace!("cl_revocation_key_private_to_json: entity >>> rev_key_priv: {:?}", secret!(&rev_key_priv));

    let res = match serde_json::to_string(rev_key_priv) {
        Ok(rev_key_priv_json) => {
            trace!("cl_revocation_key_private_to_json: rev_key_priv_json: {:?}", secret!(&rev_key_priv_json));
            unsafe {
                ...
                *rev_key_priv_json_p = rev_reg_def_priv_json.into_raw();
                trace!("cl_revocation_key_private_to_json: rev_key_priv_json_p: {:?}", *rev_key_priv_json_p);
            }
            ErrorCode::Success
        }
        Err(_) => ErrorCode::CommonInvalidState
    ...
    trace!("cl_revocation_key_private_to_json: <<< res: {:?}", res);
    res
}
...
/// by calling cl_revocation_key_private_free
///
/// # Arguments
/// * `rev_key_priv_json` - Reference that contains revocation key private json.
/// * `rev_key_priv_p` - Reference that will contain revocation key private instance pointer
#[no_mangle]
pub extern fn cl_revocation_key_private_from_json(rev_key_priv_json: *const c_char,
                                                              rev_key_priv_p: *mut *const c_void) -> ErrorCode {
    trace!("cl_revocation_key_private_from_json: >>> rev_key_priv_json: {:?}, rev_key_priv_p: {:?}",
    ...
    trace!("cl_revocation_key_private_from_json: entity: rev_key_priv_json: {:?}", secret!(&rev_key_priv_json));

    let res = match serde_json::from_str::<RevocationKeyPrivate>(&rev_key_priv_json) {
        Ok(rev_key_priv) => {
            trace!("cl_revocation_key_private_from_json: rev_key_priv: {:?}", secret!(&rev_key_priv));
            unsafe {
                *rev_key_priv_p = Box::into_raw(Box::new(rev_key_priv)) as *const c_void;
                trace!("cl_revocation_key_private_from_json: *rev_key_priv_p: {:?}", *rev_key_priv_p);
            }
            ErrorCode::Success
        }
        Err(_) => ErrorCode::CommonInvalidStructure
    ...
    trace!("cl_revocation_key_private_from_json: <<< res: {:?}", res);
    res
}
...
#[no_mangle]
pub extern fn cl_revocation_key_private_free(rev_key_priv: *const c_void) -> ErrorCode {
    trace!("cl_revocation_key_private_free: >>> rev_key_priv: {:?}", rev_key_priv);
    ...
    trace!("cl_revocation_key_private_free: entity: rev_key_priv: {:?}", secret!(_rev_key_priv));

    let res = ErrorCode::Success;

    trace!("cl_revocation_key_private_free: <<< res: {:?}", res);
    res
}
...
#[no_mangle]
pub extern fn cl_revocation_registry_to_json(rev_reg: *const c_void,
                                                         rev_reg_json_p: *mut *const c_char) -> ErrorCode {
    trace!("cl_revocation_registry_to_json: >>> rev_reg: {:?}, rev_reg_json_p: {:?}",
    ...
    trace!("cl_revocation_registry_to_json: entity >>> rev_reg: {:?}", rev_reg);

    let res = match serde_json::to_string(rev_reg) {
        Ok(rev_reg_json) => {
            trace!("cl_revocation_registry_to_json: rev_reg_json: {:?}", rev_reg_json);
            unsafe {
                let rev_reg_json = CTypesUtils::string_to_cstring(rev_reg_json);
                *rev_reg_json_p = rev_reg_json.into_raw();
                trace!("cl_revocation_registry_to_json: rev_reg_json_p: {:?}", *rev_reg_json_p);
            }
            ErrorCode::Success
        }
        Err(_) => ErrorCode::CommonInvalidState
    ...
    trace!("cl_revocation_registry_to_json: <<< res: {:?}", res);
    res
}
...
/// by calling cl_revocation_registry_free
///
/// # Arguments
/// * `rev_reg_json` - Reference that contains revocation registry json.
/// * `rev_reg_p` - Reference that will contain revocation registry instance pointer
#[no_mangle]
pub extern fn cl_revocation_registry_from_json(rev_reg_json: *const c_char,
                                                           rev_reg_p: *mut *const c_void) -> ErrorCode {
    trace!("cl_revocation_registry_from_json: >>> rev_reg_json: {:?}, rev_reg_p: {:?}",
    ...
    trace!("cl_revocation_registry_from_json: entity: rev_reg_json: {:?}", rev_reg_json);

    let res = match serde_json::from_str::<RevocationRegistry>(&rev_reg_json) {
        Ok(rev_reg) => {
            trace!("cl_revocation_registry_from_json: rev_reg: {:?}", rev_reg);
            unsafe {
                *rev_reg_p = Box::into_raw(Box::new(rev_reg)) as *const c_void;
                trace!("cl_revocation_registry_from_json: *rev_reg_p: {:?}", *rev_reg_p);
            }
            ErrorCode::Success
        }
        Err(_) => ErrorCode::CommonInvalidStructure
    ...
    trace!("cl_revocation_registry_from_json: <<< res: {:?}", res);
    res
}
...
#[no_mangle]
pub extern fn cl_revocation_registry_free(rev_reg: *const c_void) -> ErrorCode {
    trace!("cl_revocation_registry_free: >>> rev_reg: {:?}", rev_reg);
    ...
    trace!("cl_revocation_registry_free: entity: rev_reg: {:?}", rev_reg);

    let res = ErrorCode::Success;

    trace!("cl_revocation_registry_free: <<< res: {:?}", res);
    res
}
...
#[no_mangle]
pub extern fn cl_revocation_tails_generator_to_json(rev_tails_generator: *const c_void,
                                                                rev_tails_generator_json_p: *mut *const c_char) -> ErrorCode {
    trace!("cl_revocation_tails_generator_to_json: >>> rev_tails_generator: {:?}, rev_tails_generator_json_p: {:?}",
    ...
    trace!("cl_revocation_tails_generator_to_json: entity >>> rev_tails_generator: {:?}", rev_tails_generator);

    let res = match serde_json::to_string(rev_tails_generator) {
        Ok(rev_tails_generator_json) => {
            trace!("cl_revocation_tails_generator_to_json: rev_tails_generator_json: {:?}", rev_tails_generator_json);
            unsafe {
                ...
                *rev_tails_generator_json_p = rev_tails_generator_json.into_raw();
                trace!("cl_revocation_tails_generator_to_json: rev_tails_generator_json_p: {:?}", *rev_tails_generator_json_p);
            }
            ErrorCode::Success
        }
        Err(_) => ErrorCode::CommonInvalidState
    ...
    trace!("cl_revocation_tails_generator_to_json: <<< res: {:?}", res);
    res
}
...
/// by calling cl_revocation_tails_generator_free
///
/// # Arguments
/// * `rev_tails_generator_json` - Reference that contains revocation tails generator json.
/// * `rev_tails_generator_p` - Reference that will contain revocation tails generator instance pointer
#[no_mangle]
pub extern fn cl_revocation_tails_generator_from_json(rev_tails_generator_json: *const c_char,
                                                                  rev_tails_generator_p: *mut *const c_void) -> ErrorCode {
    trace!("cl_revocation_tails_generator_from_json: >>> rev_tails_generator_json: {:?}, rev_tails_generator_p: {:?}",
    ...
    trace!("cl_revocation_tails_generator_from_json: entity: rev_tails_generator_json: {:?}", rev_tails_generator_json);

    let res = match serde_json::from_str::<RevocationTailsGenerator>(&rev_tails_generator_json) {
        Ok(rev_tails_generator) => {
            trace!("cl_revocation_tails_generator_from_json: rev_tails_generator: {:?}", rev_tails_generator);
            unsafe {
                *rev_tails_generator_p = Box::into_raw(Box::new(rev_tails_generator)) as *const c_void;
                trace!("cl_revocation_tails_generator_from_json: *rev_tails_generator_p: {:?}", *rev_tails_generator_p);
            }
            ErrorCode::Success
        }
        Err(_) => ErrorCode::CommonInvalidStructure
    ...
    trace!("cl_revocation_tails_generator_from_json: <<< res: {:?}", res);
    res
}
...
#[no_mangle]
pub extern fn cl_revocation_tails_generator_free(rev_tails_generator: *const c_void) -> ErrorCode {
    trace!("cl_revocation_tails_generator_free: >>> rev_tails_generator: {:?}", rev_tails_generator);
    ...
    trace!("cl_revocation_tails_generator_free: entity: rev_tails_generator: {:?}", rev_tails_generator);

    let res = ErrorCode::Success;

    trace!("cl_revocation_tails_generator_free: <<< res: {:?}", res);
    res
}
...
///
/// Note that credential signature correctness proof instances deallocation must be performed by
/// calling cl_revocation_registry_delta_free.
///
/// # Arguments
/// * `prover_id` - Prover identifier.
/// * `blinded_credential_secrets` - Blinded master secret instance pointer generated by Prover.
...
#[no_mangle]
pub extern fn cl_issuer_sign_credential_with_revoc(prover_id: *const c_char,
                                                               blinded_credential_secrets: *const c_void,
                                                               blinded_credential_secrets_correctness_proof: *const c_void,
                                                               credential_nonce: *const c_void,
                                                               credential_issuance_nonce: *const c_void,
...
pub extern fn cl_revocation_registry_delta_to_json(revocation_registry_delta: *const c_void,
    ...
    trace!("cl_revocation_registry_delta_to_json: >>> revocation_registry_delta: {:?}, revocation_registry_delta_json_p: {:?}",
...
pub extern fn cl_revocation_registry_delta_from_json(revocation_registry_delta_json: *const c_char,
                                                                 revocation_registry_delta_p: *mut *const c_void) -> ErrorCode {
    trace!("cl_revocation_registry_delta_from_json: >>> revocation_registry_delta_json: {:?}, revocation_registry_delta_p: {:?}",
...
#[no_mangle]
pub extern fn revocation_registry_delta_from_parts(rev_reg_from: *const c_void,
    ...
    trace!("revocation_registry_delta_from_parts: >>> rev_reg_from: {:?}, rev_reg_to: {:?}, issued: {:?},\
    ...
    trace!("revocation_registry_delta_from_parts: >>> rev_reg_from: {:?}, rev_reg_to: {:?}, issued: {:?}, revoked: {:?}",
           rev_reg_from, rev_reg_to, issued, revoked);

    let rev_reg_delta =
        RevocationRegistryDelta::from_parts(rev_reg_from, rev_reg_to, &issued, &revoked);

    trace!("revocation_registry_delta_from_parts: rev_reg_delta: {:?}", rev_reg_delta);

    unsafe {
        *rev_reg_delta_p = Box::into_raw(Box::new(rev_reg_delta)) as *const c_void;
        trace!("revocation_registry_delta_from_parts: *rev_reg_delta_p: {:?}", *rev_reg_delta_p);
    }

    let res = ErrorCode::Success;

    trace!("revocation_registry_delta_from_parts: <<< res: {:?}", res);
    res
}
...
pub extern fn cl_issuer_revoke_credential(rev_reg: *const c_void,
                                                      max_cred_num: u32,
                                                      rev_idx: u32,
                                                      ctx_tails: *const c_void,
                                                      take_tail: FFITailTake,
                                                      put_tail: FFITailPut,
                                                      rev_reg_delta_p: *mut *const c_void) -> ErrorCode {
    trace!("cl_issuer_revoke_credential: >>> rev_reg: {:?}, max_cred_num: {:?}, rev_idx: {:?}, ctx_tails {:?}, take_tail {:?}, \
    ...
    trace!("cl_issuer_revoke_credential: entities: rev_reg: {:?}", secret!(&rev_reg));
    ...
    let res = match Issuer::revoke_credential(rev_reg, max_cred_num, rev_idx, &rta) {
        Ok(rev_reg_delta) => {
            unsafe {
                *rev_reg_delta_p = Box::into_raw(Box::new(rev_reg_delta)) as *const c_void;
                trace!("cl_issuer_revoke_credential: *rev_reg_delta_p: {:?}", *rev_reg_delta_p);
            }
            ErrorCode::Success
        }
        Err(err) => err.to_error_code()
    ...
    trace!("cl_issuer_revoke_credential: <<< res: {:?}", res);
    ErrorCode::Success
}
...
#[no_mangle]
#[allow(unused_variables)]
pub extern fn cl_issuer_recovery_credential(rev_reg: *const c_void,
                                                        max_cred_num: u32,
                                                        rev_idx: u32,
                                                        ctx_tails: *const c_void,
                                                        take_tail: FFITailTake,
                                                        put_tail: FFITailPut,
                                                        rev_reg_delta_p: *mut *const c_void) -> ErrorCode {
    trace!("cl_issuer_recovery_credential: >>> rev_reg: {:?}, max_cred_num: {:?}, rev_idx: {:?}, ctx_tails {:?}, take_tail {:?}, \
    put_tail {:?}, rev_reg_delta_p {:?}", rev_reg, max_cred_num, rev_idx, ctx_tails, take_tail, put_tail, rev_reg_delta_p);

    check_useful_mut_c_reference!(rev_reg, RevocationRegistry, ErrorCode::CommonInvalidParam1);

    trace!("cl_issuer_recovery_credential: entities: rev_reg: {:?}", rev_reg);
    ...
    let res = match Issuer::recovery_credential(rev_reg, max_cred_num, rev_idx, &rta) {
        Ok(rev_reg_delta) => {
            unsafe {
                *rev_reg_delta_p = Box::into_raw(Box::new(rev_reg_delta)) as *const c_void;
                trace!("cl_issuer_recovery_credential: *rev_reg_delta_p: {:?}", *rev_reg_delta_p);
            }
            ErrorCode::Success
        }
        Err(err) => err.to_error_code()
    ...
    trace!("cl_issuer_recovery_credential: <<< res: {:?}", res);
    ErrorCode::Success
}

#[no_mangle]
pub extern fn cl_issuer_merge_revocation_registry_deltas(revoc_reg_delta: *const c_void,
                                                                     other_revoc_reg_delta: *const c_void,
                                                                     merged_revoc_reg_delta_p: *mut *const c_void) -> ErrorCode {
    trace!("cl_issuer_merge_revocation_registry_deltas: >>> revoc_reg_delta: {:?}, other_revoc_reg_delta: {:?}",
    ...
    trace!("cl_issuer_merge_revocation_registry_deltas: entities: revoc_reg_delta: {:?}, other_revoc_reg_delta: {:?}",
           revoc_reg_delta, other_revoc_reg_delta);

    let res = match revoc_reg_delta.merge(other_revoc_reg_delta) {
        Ok(merged_revoc_reg_delta) => {
            trace!("cl_issuer_merge_revocation_registry_deltas: merged_revoc_reg_delta: {:?}", merged_revoc_reg_delta);
            unsafe {
                *merged_revoc_reg_delta_p = Box::into_raw(Box::new(merged_revoc_reg_delta)) as *const c_void;
                trace!("cl_issuer_merge_revocation_registry_deltas: *merged_revoc_reg_delta_p: {:?}", *merged_revoc_reg_delta_p);
            }
            ErrorCode::Success
        }
        Err(err) => err.to_error_code()
    ...
    trace!("cl_issuer_merge_revocation_registry_deltas: <<< res: {:?}", res);
    res
}
...
mod tests {
    ...
    #[test]
    fn cl_issuer_new_revocation_registry_def_works() {
        let (credential_pub_key, credential_priv_key, credential_key_correctness_proof) = _credential_def();
        ...
        let err_code = cl_issuer_new_revocation_registry_def(credential_pub_key,
                                                                         100,
                                                                         false,
                                                                         &mut rev_key_pub_p,
                                                                         &mut rev_key_priv_p,
    ...
    #[test]
    fn cl_revocation_key_public_to_json_works() {
        let (credential_pub_key, credential_priv_key, credential_key_correctness_proof) = _credential_def();
        ...
        let err_code = cl_revocation_key_public_to_json(rev_key_pub, &mut rev_key_pub_json_p);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    #[test]
    fn cl_revocation_key_public_from_json_works() {
        let (credential_pub_key, credential_priv_key, credential_key_correctness_proof) = _credential_def();
        let (rev_key_pub, rev_key_priv, rev_reg, rev_tails_generator) = _revocation_registry_def(credential_pub_key);
        ...
        let mut rev_key_pub_p: *const c_void = ptr::null();
        let err_code = cl_revocation_key_public_from_json(rev_key_pub_json_p, &mut rev_key_pub_p);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    #[test]
    fn cl_revocation_key_private_to_json_works() {
        let (credential_pub_key, credential_priv_key, credential_key_correctness_proof) = _credential_def();
        let (rev_key_pub, rev_key_priv, rev_reg, rev_tails_generator) = _revocation_registry_def(credential_pub_key);

        let mut rev_key_priv_json_p: *const c_char = ptr::null();
        let err_code = cl_revocation_key_private_to_json(rev_key_priv, &mut rev_key_priv_json_p);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    #[test]
    fn cl_revocation_key_private_from_json_works() {
        let (credential_pub_key, credential_priv_key, credential_key_correctness_proof) = _credential_def();
        let (rev_key_pub, rev_key_priv, rev_reg, rev_tails_generator) = _revocation_registry_def(credential_pub_key);
        ...
        let mut rev_key_priv_p: *const c_void = ptr::null();
        let err_code = cl_revocation_key_private_from_json(rev_key_priv_json_p, &mut rev_key_priv_p);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    #[test]
    fn cl_revocation_registry_to_json_works() {
        let (credential_pub_key, credential_priv_key, credential_key_correctness_proof) = _credential_def();
        let (rev_key_pub, rev_key_priv, rev_reg, rev_tails_generator) = _revocation_registry_def(credential_pub_key);

        let mut rev_reg_json_p: *const c_char = ptr::null();
        let err_code = cl_revocation_registry_to_json(rev_reg, &mut rev_reg_json_p);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    #[test]
    fn cl_revocation_registry_from_json_works() {
        let (credential_pub_key, credential_priv_key, credential_key_correctness_proof) = _credential_def();
        let (rev_key_pub, rev_key_priv, rev_reg, rev_tails_generator) = _revocation_registry_def(credential_pub_key);
        ...
        let mut rev_reg_p: *const c_void = ptr::null();
        let err_code = cl_revocation_registry_from_json(rev_reg_json_p, &mut rev_reg_p);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    #[test]
    fn cl_revocation_tails_generator_to_json_works() {
        let (credential_pub_key, credential_priv_key, credential_key_correctness_proof) = _credential_def();
        let (rev_key_pub, rev_key_priv, rev_reg, rev_tails_generator) = _revocation_registry_def(credential_pub_key);

        let mut rev_tails_generator_json_p: *const c_char = ptr::null();
        let err_code = cl_revocation_tails_generator_to_json(rev_tails_generator, &mut rev_tails_generator_json_p);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    #[test]
    fn cl_revocation_tails_generator_from_json_works() {
        let (credential_pub_key, credential_priv_key, credential_key_correctness_proof) = _credential_def();
        let (rev_key_pub, rev_key_priv, rev_reg, rev_tails_generator) = _revocation_registry_def(credential_pub_key);
        ...
        let mut rev_tails_generator_p: *const c_void = ptr::null();
        let err_code = cl_revocation_tails_generator_from_json(rev_tails_generator_json_p, &mut rev_tails_generator_p);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    #[test]
    fn cl_revocation_registry_def_free_works() {
        let (credential_pub_key, credential_priv_key, credential_key_correctness_proof) = _credential_def();
        let (rev_key_pub, rev_key_priv, rev_reg, rev_tails_generator) = _revocation_registry_def(credential_pub_key);

        let err_code = cl_revocation_key_public_free(rev_key_pub);
        assert_eq!(err_code, ErrorCode::Success);

        let err_code = cl_revocation_key_private_free(rev_key_priv);
        assert_eq!(err_code, ErrorCode::Success);

        let err_code = cl_revocation_registry_free(rev_reg);
        assert_eq!(err_code, ErrorCode::Success);

        let err_code = cl_revocation_tails_generator_free(rev_tails_generator);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    #[test]
    fn cl_issuer_sign_credential_with_revoc_works() {
        ...
        let err_code = cl_issuer_sign_credential_with_revoc(prover_id.as_ptr(),
                                                                        blinded_credential_secrets,
                                                                        blinded_credential_secrets_correctness_proof,
                                                                        credential_nonce,
                                                                        credential_issuance_nonce,
    ...
    #[test]
    fn cl_issuer_revoke_credential_works() {
        let credential_values = _credential_values();
        let (credential_pub_key, credential_priv_key, credential_key_correctness_proof) = _credential_def();
        let (rev_key_pub, rev_key_priv, rev_reg, rev_tails_generator) = _revocation_registry_def(credential_pub_key);
        let credential_nonce = _nonce();
        ...
        let err_code = cl_issuer_revoke_credential(rev_reg,
                                                               5,
                                                               1,
                                                               tail_storage.get_ctx(),
                                                               FFISimpleTailStorage::tail_take,
    ...
    #[test]
    fn cl_revocation_registry_delta_from_parts_works() {
        let (credential_pub_key, credential_priv_key, credential_key_correctness_proof) = _credential_def();
        let (rev_key_pub, rev_key_priv, rev_reg, rev_tails_generator) = _revocation_registry_def(credential_pub_key);
        ...
        let err_code = revocation_registry_delta_from_parts(rev_reg_from,
                                                                        rev_reg,
                                                                        issued, issued_len,
                                                                        revoked, revoked_len,
                                                                        &mut rev_reg_delta_p);
    ...
    #[test]
    fn cl_issuer_merge_revoc_deltas_works() {
        let (credential_pub_key, credential_priv_key, credential_key_correctness_proof) = _credential_def();
        let (rev_key_pub, rev_key_priv, rev_reg, rev_tails_generator) = _revocation_registry_def(credential_pub_key);
        let credential_values = _credential_values();
        let credential_nonce = _nonce();
        ...
        let err_code = cl_issuer_merge_revocation_registry_deltas(revocation_registry_delta,
...
//        _free_credential_values(credential_values);
    ...
    pub fn _free_credential_signature_with_revoc(credential_signature: *const c_void, signature_correctness_proof: *const c_void,
        ...
        let err_code = cl_revocation_registry_delta_free(revocation_registry_delta);
        assert_eq!(err_code, ErrorCode::Success);
    }
